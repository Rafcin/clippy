...
const QA_PROMPT = PromptTemplate.fromTemplate(
  ...
  If the question is not related to the provided context or the specific topic mentioned, politely inform them that you are tuned to only answer questions that are related to the given context and topic.
