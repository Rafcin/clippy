...
export const UserUpdateOneWithoutSessionsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutSessionsNestedInput> = z.object({
...
export default UserUpdateOneWithoutSessionsNestedInputSchema;
