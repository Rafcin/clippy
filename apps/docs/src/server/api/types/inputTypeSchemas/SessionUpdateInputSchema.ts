...
import { UserUpdateOneWithoutSessionsNestedInputSchema } from './UserUpdateOneWithoutSessionsNestedInputSchema';
...
export const SessionUpdateInputSchema: z.ZodType<Prisma.SessionUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneWithoutSessionsNestedInputSchema).optional()
}).strict();
